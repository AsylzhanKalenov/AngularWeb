...
namespace AngularWeb.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(AngDbContext context)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,EmployeeKol,City")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,EmployeeKol,City")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
